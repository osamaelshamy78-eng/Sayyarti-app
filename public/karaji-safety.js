(function () {
  ...
  function openAbout() {
    ...
    const title=document.createElement("h2"); title.textContent=ar?"عن سيارتي":"About Sayyarti"; Object.assign(title.style,{margin:ar?"0 0 10px 42px":"0 42px 10px 0",color:C.amber,fontSize:"24px"});
    const p1=document.createElement("p"); p1.textContent=ar?"سيارتي منصة رقمية ثنائية اللغة تساعد أصحاب السيارات على فهم مشاكل السيارة، استكشاف الأعطال، وتحويل نتيجة البحث إلى خطوة عملية مثل مشاهدة فيديو مناسب أو الوصول إلى جراج قريب.":"Sayyarti is a bilingual digital platform that helps car owners understand vehicle problems, explore common faults, and turn the result into a practical next step such as watching a relevant video or finding a nearby garage."; p1.style.color=C.dim; p1.style.lineHeight="1.8";
    const p2=document.createElement("p"); p2.textContent=ar?"يوفر سيارتي أيضًا دليلًا للجراجات، وميزات لإضافة الجراجات، وإعلانات السيارات، ومحتوى إرشادي عن أعطال السيارات.":"Sayyarti also provides a garage directory, garage listing tools, vehicle listings, and educational car-fault guidance."; p2.style.color=C.dim; p2.style.lineHeight="1.8";
  ...
  function addGarageNetworkCta(){
    ...
    const text=document.createElement("div"); text.textContent=ar?"أضف جراجك إلى دليل سيارتي مجانًا، وعرّف أصحاب السيارات بخدماتك وموقعك وبيانات التواصل.":"Add your garage to the Sayyarti directory for free and let car owners discover your services, location and contact details."; Object.assign(text.style,{color:C.dim,fontSize:"12px",lineHeight:"1.7",marginBottom:"10px"});
